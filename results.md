...
This document summarizes the outputs produced by the **Sparxiv** end‑to‑end Apache Spark analytics pipeline.  
All results below are generated by running the project’s ingestion, transformation, ML feature extraction, search, streaming, and complex SQL analytics components.
